...
public class SortedLargeFile {
    ...
    /** Sort data in source file into targe file */
    public static void sort(String sourcefile  , String targefile) throws  Exception{
        ...
        merge(numberOfSegments,MAX_ARRAY_SIZE,"f1.dat","f2.dat","f3.dat",targefile);
    }

    private static void merge(int numberOfSegments, int segmentSize,
                              String f1, String f2, String f3, String targefile) throws Exception{
        if(numberOfSegments >1){
            ...
            File sortFile = new File(targefile);
    ...
    private static void mergeOneStep(int numberOfSegments, int segmentSize,
        ...
        mergeSegments(numberOfSegments / 2 ,segmentSize,
                f1Input,f2Input,f3Output);
    ...
    private static void mergeSegments(int numberOfSegments,
                         int segmentSize, DataInputStream f1, DataInputStream
            f2, DataOutputStream f3) throws  Exception{
    ...
    public static int initializeSegments(int segmentSize , String originalFile,
