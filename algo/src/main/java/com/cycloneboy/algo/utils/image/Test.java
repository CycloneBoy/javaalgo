...
/**
 * Create by  sl on 2019-08-29 21:57
 */
public class Test {

  public static void main(String[] args) throws Exception {
    //
    recordWebcamAndMicrophone(0, 4, "/home/sl/workspace", 720, 560, 30);
   ...
   */
  public static void recordWebcamAndMicrophone(int WEBCAM_DEVICE_INDEX, int AUDIO_DEVICE_INDEX,
      String outputFile,
     ...
     */
    FFmpegFrameRecorder recorder = new FFmpegFrameRecorder(outputFile, captureWidth, captureHeight,
        2);
    ...
    while ((capturedFrame = grabber.grab()) != null) {
      ...
      if (videoTS > recorder.getTimestamp()) {
        System.out
            .println("Lip-flap correction: " + videoTS + " : " + recorder.getTimestamp() + " -> "
