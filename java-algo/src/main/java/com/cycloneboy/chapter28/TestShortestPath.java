...
public class TestShortestPath {
	...
	public static void main(String[] args) {
		...
		//Display shortest paths form Houston to Chicago
		System.out.println("\nShortest paths form Houston to Chicago: ");
		List<String> path = tree1.getPath(graph1.getIndex("Houston"));
		for(String s : path){
			System.out.print(s + " ");
		}
		System.out.println();
		...
		WeightedGraph<Integer>  graph2 = new WeightedGraph<>(edges2,5);
